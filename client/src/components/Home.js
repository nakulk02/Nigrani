...
const loca_regex=new RegExp(/^[a-zA-Z ]/);
...
export default function Home() {
  ...
  const onSuggest=async(e)=>{
    ...
    e.preventDefault();
    console.log("XFvfv",suggest);
    await api.get(`suggestion/${suggest}`).then((res)=>{
      console.log(res,"suggestions sent");
    ...
    <>
      ...
      <div className="body">
        ...
        <div className='bg total'>
              ...
              <div className="row">
                <div className="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1">
                  ...
                  <div className="d-flex justify-content-center justify-content-lg-start">
                    ...
                    <a href="https://drive.google.com/file/d/1AmN_9tapQ6YDyK3zeFiHP4P1LUlOiGTV/view" className="glightbox btn-watch-video"><i className="bi bi-play-circle"></i><span>Watch Video</span></a>
                  </div>
                </div>
          ...
          {/* <section id="sch" className="align-items-center"> */}
          <div id="sch" className="search-container">
            ...
            <button type="button" id="schbtn" className="bt" onClick={onSubmit}><h5>Submit</h5></button>
          ...
          <div className='my-3'>
                  ...
                  <div className="card mx-3">
                    ...
                    <div className="card-body">
                      <div>
                        ...
                        <p>Distance from facility: {searchResult.dist["calculated"]/600} Kms.</p>
                      ...
                      <div><iframe src={`https://www.google.com/maps?q=${searchResult.location["coordinates"][0]},${searchResult.location["coordinates"][1]}&hl=es:&output=embed`} id="map"></iframe></div>
                      {console.log(searchResult.city,searchResult)}
            ...
            {(nor === 0) && <h4 className="my-3">No results</h4>}
          </div>
              ...
              <div className="row">
                ...
                <div className="col-lg-6 pt-4 pt-lg-0 content" data-aos-delay="100">
                  ...
                  <div className="progress">
                    ...
                    <div className="progress">
                      <span className="skill">Express.js <i className="val">100%</i></span>
                      {/* <div className="progress-bar-wrap">
                    ...
                    <div className="progress">
                      <span className="skill">Axios <i className="val">90%</i></span>
                      {/* <div className="progress-bar-wrap">
...
<!-- ======= Services Section ======= --> */}
          <section id="services" className="services section-bg">
            <div className="container">
              ...
              <div className="section-title">
                <h2>Services and Future Scope</h2>
              ...
              <div className="row">
                ...
                <div className="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos-delay="400">
                  <div className="icon-box">
                    ...
                    <p>For use in areas with harsh climatic conditions which is a part of our future scope.</p>
                  </div>
                </div>
...
<!-- ======= Team Section ======= --> */}
          <section id="team" className="team section-bg">
            <div className="container">
              ...
              <div className="section-title">
                <h2>Team</h2>
                <p>Members that have contributed to this project</p>
              </div>
              ...
              <div className="row">
                ...
                <div className="col-lg-6">
                  <div className="member d-flex align-items-start">
                    <div className="pic"><img src={require('../assets/img/team/nakul.jpeg')} alt="Nakul Kankarwal" className="img-fluid"></img></div>
                ...
                <div className="col-lg-6 mt-4 mt-lg-0">
                  <div className="member d-flex align-items-start" data-aos-delay="200">
                    <div className="pic"><img src={require('../assets/img/team/aniket.jpeg')} className="img-fluid" alt=""></img></div>
                    <div className="member-info">
                      <h4>Aniket Sood</h4>
                      <span>19105080</span>
                      <p>Software</p>
                ...
                <div className="col-lg-6 mt-4">
                  <div className="member d-flex align-items-start" data-aos-delay="300">
                    <div className="pic"><img src={require('../assets/img/team/arihant.jpeg')} className="img-fluid" alt=""></img></div>
                    <div className="member-info">
                      <h4>Arihant Jain</h4>
                      <span>19105086</span>
                      <p>Software</p>
                ...
                <div className="col-lg-6 mt-4">
                  <div className="member d-flex align-items-start" data-aos-delay="400">
                    <div className="pic"><img src={require('../assets/img/team/saksham.jpeg')} className="img-fluid" alt=""></img></div>
                    <div className="member-info">
                      <h4>Saksham Arora</h4>
                      <span>19105089</span>
                      <p>Hardware</p>
                ...
                <div className="col-lg-6 mt-4">
                  <div className="member d-flex align-items-start" data-aos-delay="400">
                    <div className="pic"><img src={require('../assets/img/team/archit.jpeg')} className="img-fluid" alt=""></img></div>
                    <div className="member-info">
                      <h4>Archit Ghai</h4>
                      <span>19105102</span>
                      <p>Hardware</p>
                ...
                <div className="col-lg-6 mt-4">
                  <div className="member d-flex align-items-start" data-aos-delay="400">
                    <div className="pic"><img src={require('../assets/img/team/utkarsh.jpeg')} className="img-fluid" alt=""></img></div>
                    <div className="member-info">
            ...
            <div className="container">
              ...
              <div className="row">
                ...
                <div className="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
                  <form className="php-email-form" onSubmit={onSuggest}>
                    <div className="row">
                    ...
                    <div className="form-group">
                      ...
                      <textarea className="form-control" name="message" rows="10" required onChange={(e)=>{changeSuggest(e.target.value)}}></textarea>
                    </div>
                    <div className="my-3">
