...
const OTP_REGEX=new RegExp(/^[0-9]/);
...
export default function Otp() {
    ...
    const checkOTP = async (e) => {
        ...
        console.log('New OTP-', OTP, person);
        ...
        <>
            <form className="form-inline" onSubmit={checkOTP}>
                ...
                <div className="col-sm-10">
                    <input type="text" className="form-control mx-3" id="inputOTP" autoComplete="off" required={true} placeholder="" onChange={(e) => setOTP(e.target.value)} />
